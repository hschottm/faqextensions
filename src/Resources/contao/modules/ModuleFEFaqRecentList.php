...
class ModuleFEFaqRecentList extends \Contao\ModuleFaqList
{
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### ' . utf8_strtoupper($GLOBALS['TL_LANG']['FMD']['faqrecentlist'][0]) . ' ###';
	...
	{
		$objFaq = \Hschottm\FaqExtensionsBundle\FEFaqModel::findPublishedByDate(array("limit" => (($this->faq_limit > 0) ? $this->faq_limit : 10)));
